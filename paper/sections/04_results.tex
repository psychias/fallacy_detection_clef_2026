We report the dev-partition and cross-validation results for our submitted systems and the wider grid of backbones and recipes we evaluated. Every number in this initial submission is macro-averaged F1 on the held-out development partition or, where flagged, the mean of a 5-fold cross-validation on that partition; test-set leaderboard numbers will be incorporated in the camera-ready version of this notebook. The caveat is stated once here and not repeated in each table caption or subsection.
